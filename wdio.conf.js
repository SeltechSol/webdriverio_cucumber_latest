const browserSetup = require('./settings/wdio.browsers.setup')
const info = require('./settings/info');


var datetime = info.getFormattedDate("_","_");
...
exports.config = {
    ...
    reporters: ['spec','multiple-cucumber-html','allure'],//,'junit'],//,'json'],//,'junit','allure','json'],
    reporterOptions : {
        //  junit : {
        //   outputDir : './JUnit',
        //   outputFileFormat: {
        ...
        allure : {
          ...
          ,pageTitle : 'Webdriver Cucumber Latest Test Title'
          ,reportName : 'Webdriver Cucumber Latest Test Report'
          ,pageFooter : '<div><center><p> Webdriver Cucumber Latest Test UI Report by Khurram Syed</p></center></div>'
          ,customData: {
            title: 'Run info',
            data: [
                {label: 'Project', value: 'Webdriver Cucumber Latest'},
                {label: 'Release', value: '1.0.10'},
    ...
    cucumberOpts: {
        require: require('glob').sync('./test/steps/*.js'),        // <string[]> (file/dir) require files before executing features
